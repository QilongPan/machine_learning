# -*- coding: utf-8 -*-
# @Author: Qilong Pan
# @Date:   2018-12-29 10:22:36
# @Last Modified by:   Qilong Pan
# @Last Modified time: 2018-12-29 10:56:43
#reference:https://blog.csdn.net/lilong117194/article/details/78906488 
# coding=utf-8
import random
...
def is_finished(fitnesses):
    ...
    for v in fitnesses:
        if v[1] > max_current:
            max_current = v[1]
    print('max_current:%d'%(max_current))  # 得到当前最大的价值
...
def crossover(chromosome_states, selected_index):
    ...
    while index >= 0: # 遍历完所有的染色体组的染色体（其中下标-1代表最后一个染色体的索引）
        ...
        print('chromosome_states_3:')
        print(chromosome_states) # 弹出后的染色体组
        print('chromosome_state:')
        print(chromosome_state)  # 弹出的染色体
